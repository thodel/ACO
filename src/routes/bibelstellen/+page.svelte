			...
			<Accordion.Item value={book.book}>
				<h3>
					<Accordion.ItemTrigger class="hover:bg-primary-200/60 hover:dark:bg-primary-500">
						...
						<span class="text-surface-950-50 opacity-70 ml-2 text-sm"
							>({book.count})</span
						>
							...
							{#each book.refs as ref}
								<li>
									<div class="flex flex-wrap items-baseline gap-x-2">
										...
										<span class="text-surface-950-50 opacity-70 text-sm"
											>({ref.count})</span
										>
									</div>
...
<div class="bible-index">
	...
	{#if filteredCount === 0}
		<p class="text-surface-950-50 opacity-70 mt-6">
...
<style>
	...
	.facet-actions button {
		@apply bg-primary-200 dark:bg-primary-500 text-surface-950-50 rounded-md px-3 py-1 text-sm;
	}
